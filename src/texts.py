...
class MessageTexts:
    ...
    START = (
        ...
        "📸 برای شروع، لطفا یک عکس از محصول خود را برای من ارسال کنید یا از دستور /generate استفاده کنید."
    )
    ...
    HELP = (
        ...
        "اعتبار شما برای هر بار تولید تصویر کسر می‌شود. همیشه می‌توانید با دستور /buy اعتبار خود را افزایش دهید."
    )
    ...
    CONFIRMATION_PROMPT_TEMPLATE = "لطفا درخواست خود را بازبینی و تایید کنید:\n\n**قالب انتخابی:** {template_name}\n**نام محصول:** {product_name}"
    CONFIRMATION_PROMPT_MANUAL = "لطفا درخواست خود را بازبینی و تایید کنید:\n\n**توضیحات شما:**\n{description}"
    CONFIRMATION_PROMPT_AUTOMATIC = "لطفا درخواست خود را بازبینی و تایید کنید:\n\n**توضیحات شما:**\n{description}"
...
class ButtonLabels:
    ...
    RESEND_IMAGE = "📥 دریافت مجدد خروجی"
